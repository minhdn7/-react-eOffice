        ...
        <View style = {{flex: 1}}>
            ...
            <View style={{flex: 1, alignItems:'center'}}>
                ...
                <View style={{height: 35, flexDirection:'row'}}>
                    <Button style={[itemStyles.buttonStyle, {backgroundColor:'#205AA7'}]}>
                        <Text style={{color: 'white'}}>Tìm kiếm</Text>
                    </Button>
                    <Button style={[itemStyles.buttonStyle, {backgroundColor:'#367517'}]} onPress={() => this.props.navigation.navigate('SendThongTin')}>
